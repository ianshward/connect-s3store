...
var S3 = module.exports = function(options) {
    ...
    this.client = henry.createClient({
        key: options.awsKey,
...
S3.prototype.put = function(id, object, cb) {
    ...
    this.client.put(this.prefix + id, {
...
S3.prototype.get = function(id, cb) {
    this.client.get(this.prefix + id, function(err, req) {
        if (err) return cb(err);
        req.on('error', cb);
        req.on('response', function(res) {
            var string = '';
...
S3.prototype.del = function(id, cb) {
    this.client.del(this.prefix + id, function(err, req) {
        if (err) return cb(err);
        req.on('error', cb);
        req.on('response', function(res) {
